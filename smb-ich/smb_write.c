...
int ich_smbus_write(resmgr_context_t* ctp, io_devctl_t* msg, ich_ocb_t* ocb)
{
    ...
    switch (cmd_type)
    {
        case SMBUS_CMD_QUICK:
             ...
             write_smbus(dev, ICH_SMBUS_XMIT_SLVA, (slv_addr<<1) | NSXS_WRITE);
        ...
        case SMBUS_CMD_BYTE_DATA:
             ...
             write_smbus(dev, ICH_SMBUS_AUX_CTL, 0x00000000);
             /* Set data registers */
             write_smbus(dev, ICH_SMBUS_HST_D0, data & 0x000000FF);
             write_smbus(dev, ICH_SMBUS_HST_D1, 0x00000000);
             /* Start SMBUS transaction in BYTE mode */
        ...
        case SMBUS_CMD_WORD_DATA:
             ...
             /* Set data registers */
             write_smbus(dev, ICH_SMBUS_HST_D0, data & 0x000000FF);
             write_smbus(dev, ICH_SMBUS_HST_D1, (data>>8) & 0x000000FF);
