...
int ec_smbus_write(resmgr_context_t* ctp, io_devctl_t* msg, ec_ocb_t* ocb)
{
    ...
    buf=(uint8_t*)cmd + sizeof(smbus_cmd_t);
    ...
    buf_out=_DEVCTL_DATA(msg->o);
    buf_out+=sizeof(smbus_cmd_t);
    ...
    switch (cmd_type)
    {
        case SMBUS_CMD_QUICK:
             ...
             write_smbus(dev, SMB_PRTCL, SMB_PRTCL_WRITE_QUICK_COMMAND);
        ...
        case SMBUS_CMD_BYTE:
             ...
             write_smbus(dev, SMB_PRTCL, SMB_PRTCL_SEND_BYTE);
        ...
        case SMBUS_CMD_BYTE_DATA:
             ...
             write_smbus(dev, SMB_PRTCL, SMB_PRTCL_WRITE_BYTE);
        ...
        case SMBUS_CMD_PROCESS_CALL:
             ...
             if (length>0)
             {
                 *buf_out++=cmd_out->data & 0x000000FF;
             }
             if (length>1)
             {
                 *buf_out++=(cmd_out->data>>8) & 0x000000FF;
             }
             break;
        case SMBUS_CMD_BLOCK:
             ...
             for (it=0; it<length; it++)
             {
                 ...
                 write_smbus(dev, SMB_DATA0 + it, *buf++);
             }
        ...
        case SMBUS_CMD_BLOCK_PROCESS:
             ...
             for (it=0; it<cmd_out->length; it++)
             {
                 ...
                 *buf_out++=read_smbus(dev, SMB_DATA0 + it);
             }
             break;
        default:
